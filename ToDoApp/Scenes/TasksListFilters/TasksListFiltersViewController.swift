//
//  TasksListFiltersViewController.swift
//  ToDoApp
//
...
protocol TasksListFiltersView: BaseView {
	func display(sections: [ProjectDetailsFiltersSection])
}

// MARK: - ViewController

final class TasksListFiltersViewController: UIViewController {
	...
	var onOrderChangedAction: (() -> Void)?
	private var interactor: TasksListFiltersInteractor?
	...
	private func configureScene() {
		let view = self
		let presenter = TasksListFiltersPresenterImpl(view: view)
		let interactor = TasksListFiltersInteractorImpl(presenter: presenter)
...
extension TasksListFiltersViewController: TasksListFiltersView {
...
extension TasksListFiltersViewController: UITableViewDataSource,
										  UITableViewDelegate {
